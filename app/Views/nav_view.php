          ...
          <div class="navbar-menu-wrapper d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              <li class="nav-item nav-profile dropdown d-none d-md-block">
                ...
                <div class="dropdown-menu left navbar-dropdown" aria-labelledby="userDropdown">
                  <a class="dropdown-item" href="#">
                    <i class="mdi mdi-account"></i> </a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal-4">
                    <i class="mdi mdi-exit-to-app"></i> </a>
                </div>
              </li>
            </ul>
